...
exports.cmd = {
    ...
    category: ['download'],
    detail: {
        desc: 'Download Video from YouTube audio.',
        use: 'url'
    },
    setting: {
        error_react: true
    ...
    async start({ msg, text }) {
        ...
        const apiUrl = `${website.web}/api/download/ytmp4/v2?url=${text}&apikey=${website.apikey}`;
...
=========================`
            await msg.reply({ caption: caption, video: result.url, mimetype: 'video/mp4' });
