...
exports.cmd = {
    name: ['ytgamingtrend'],
    command: ['ytgamingtrend'],
    category: ['information'],
    detail: {
        desc: 'Information Trending Youtube Gaming.',
        use: 'negara'
    },
    setting: {
        error_react: true
    ...
    async start({ msg, text }) {
        ...
        try {
            let res = await axios.get(`${website.web}/api/info/trend/youtube/gaming?country=${text}&apikey=${website.apikey}`);
            ...
            let replyMessage = `🔍 *Information Trending Youtube Gaming*:\n\n`;
